...
import com.lvgou.lawyer.studio.adapter.BBSDetailReplyAdapter;
import com.umeng.analytics.MobclickAgent;

public class BBSDetailActivity extends Activity implements OnClickListener {
	...
	private BBSDetailReplyAdapter attAdapter;
	...
	private void initView() {
		...
		attAdapter = new BBSDetailReplyAdapter(mContext, null);
		replylist.setAdapter(attAdapter);
	}
