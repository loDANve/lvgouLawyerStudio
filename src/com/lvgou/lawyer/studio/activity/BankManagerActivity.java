...
import com.lvgou.lawyer.studio.adapter.BankCardListAdapter;
import com.umeng.analytics.MobclickAgent;

public class BankManagerActivity extends Activity implements OnClickListener {
	...
	private BankCardListAdapter attAdapter;
	...
	private void initView() {
		...
		attAdapter = new BankCardListAdapter(mContext, null);
		bankcardlist.setAdapter(attAdapter);
	}
