...
public class IntakeActivity extends Activity implements OnClickListener {
	...
	@ViewInject(R.id.intakelist)
	private ListView intakelist;

	private IntakeListAdapter adapter;
	...
	private void initView() {
		...
		adapter = new IntakeListAdapter(mContext, null);
		intakelist.setAdapter(adapter);
	}
