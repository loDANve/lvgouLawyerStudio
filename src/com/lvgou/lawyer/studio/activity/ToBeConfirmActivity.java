...
import com.lvgou.lawyer.studio.adapter.ToBeConfirmListAdapter;
import com.umeng.analytics.MobclickAgent;

public class ToBeConfirmActivity extends Activity implements OnClickListener {
	...
	@ViewInject(R.id.tobeconfirmlist)
	private ListView tobeconfirmlist;

	private ToBeConfirmListAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tobeconfirm_activity);
		mContext = this;
	...
	private void initView() {
		...
		adapter = new ToBeConfirmListAdapter(mContext, null);
		tobeconfirmlist.setAdapter(adapter);
	}
